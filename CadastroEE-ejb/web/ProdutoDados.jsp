...
<body class="container">
    ...
    <form action="ServletProdutoFC" method="post" class="form">
        ...
        <div class="mb-3">
            ...
            <input class="form-control"  type="number" name="quantidade" id="quantidade" value="${not empty produto ? produto.quantidade : ''}">
        </div>
        <div class="mb-3">
            <label for="precoVenda" class="form-label">Preço de Venda:</label>
            <input class="form-control"  type="number" name="precoVenda" id="precoVenda" min="0" step="0.01" value="${not empty produto ? produto.precoVenda : ''}">
        </div>
